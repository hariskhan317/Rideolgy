        ...
        <>
            <div className="max-w-screen-2xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
                <div className="text-center py-64">
                    <h1 className="flex justify-center gap-5 text-5xl md:text-8xl font-bold tracking-widest text-white uppercase font-quicksand rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">
                        <FontAwesomeIcon icon={faBicycle} />
                        <p>data</p> 
                    </h1>
                    <p className="mt-9 text-white tracking-widest opacity-75 text-xl md:text-2xl font-quicksand font-normal">Pedal Power and Precision: Join the Rideology Bike Show and Repair Revolution</p>
