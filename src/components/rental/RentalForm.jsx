            ...
            <form action="#" method="POST" class="">
                <div class="mx-auto w-8/12 py-20">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            <label for="first-name" class="block text-base font-bold leading-6 text-[#15182f] font-quicksand">Pickup Date</label>
                            <div class="mt-2.5">
                                <input type="date" name="date" id="Pickup_Date" class="font-quicksand block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                            </div>
                        </div>
                        <div class="sm:col-span-2">
                        ...
                        <div class="sm:col-span-2">
                            <label for="first-name" class="block text-base font-bold leading-6 text-[#15182f] font-quicksand">Message</label>
                            <div class="mt-2.5">
